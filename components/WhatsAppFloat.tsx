...
export default function WhatsAppFloat({ href }: { href: string }) {
  ...
  return (
    <a
      ...
      target="_blank"
      rel="noreferrer"
      aria-label="WhatsApp Sunlife"
      className="fixed right-4 bottom-20 z-40 grid h-12 w-12 place-items-center rounded-2xl bg-[#25D366] text-white shadow-lg md:right-6 md:h-14 md:w-14 lg:bottom-6"
    >
